...
*Ejemplo de manejo de rutas con `pathlib.Path` y copias con `shutil`: define rutas, asegura existencia de carpetas, realiza copia de un archivo a `backup` (si existe) y clona recursivamente la carpeta de datos a `data_copia`.*
