...
class Cliente:
    ...
    def __str__(self) -> str:
        return (
            ...
            + self.email
            + "> | alta "
            + self.fecha_alta.strftime(FMT)
            + " | "
            + str(self.antiguedad_dias())
            + " días"
        )
...
class Evento:
    ...
    def dias_hasta_evento(self) -> int:
        """Días que faltan desde HOY al evento (puede ser negativo si ya pasó)."""
    ...
    def __str__(self) -> str:
        return (
            ...
            + self.titulo
            + " | "
            + self.fecha_evento.strftime(FMT)
            + " ("
            + self.categoria
            + ") | aforo "
            + str(self.aforo)
            + " | "
            + str(self.dias_hasta_evento())
            + " días"
        )
...
class Venta:
    ...
    def __str__(self) -> str:
        return (
            ...
            + str(self.precio)
            + "€ | "
            + self.fecha_compra.strftime(FMT)
        )
